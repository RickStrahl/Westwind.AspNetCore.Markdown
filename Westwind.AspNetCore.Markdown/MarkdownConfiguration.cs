...
public class MarkdownConfiguration
{
    ...
    /// </summary>
    public List<MarkdownProcessingFolder> MarkdownProcessingFolders { get; set; } = new();

    /// <summary>
    /// The Markdown ParserFactory used to instantiate/cache the parser- defaults to MarkDig Factory
    /// </summary>
    ...
    /// <summary>
    /// Additional Render Extensions to extend Markdown rendering
    /// </summary>
    public List<IMarkdownRenderExtension> MarkdownRenderExtensions { get; set; } = new();
